...
cfg.LOFTR.COARSE.NEXT_TOPK = None  # real topk: 32*4=128
...
cfg.LOFTR.COARSE2.SELF_ATTN_TYPE = 'local'  # local_global, local, VAN
...
cfg.LOFTR.COARSE3.D_MODEL = 64
cfg.LOFTR.COARSE3.NHEAD = 2
cfg.LOFTR.COARSE3.LAYER_NAMES = ['cross', 'self', 'cross']
cfg.LOFTR.COARSE3.SELF_ATTN_TYPE = 'local'  # local_global, local, VAN
cfg.LOFTR.COARSE3.WINDOW_SIZE = 5
cfg.LOFTR.COARSE3.ATTN_WINDOW_SIZE = 7
cfg.LOFTR.COARSE3.PROPAGATION = 'window'  # 'dilated'
cfg.LOFTR.COARSE3.SR_RATIO = 4
cfg.LOFTR.COARSE3.DILATED = 1
cfg.LOFTR.COARSE3.RELATIVE_PE = False
cfg.LOFTR.COARSE3.TOPKS = None
cfg.LOFTR.COARSE3.DETECTOR = None  # conf/learnable/None
cfg.LOFTR.COARSE3.DETECTOR_MODE = None  # hard gumbel or ST or None
cfg.LOFTR.COARSE3.GRID_SIZE = 4

cfg.LOFTR.COARSE3.POST_CONFIG.METHOD = 'maxpool_nms'
cfg.LOFTR.COARSE3.POST_CONFIG.WINDOW_SIZE = 5
cfg.LOFTR.COARSE3.POST_CONFIG.TOPK = None
cfg.LOFTR.COARSE3.POST_CONFIG.RT = None
cfg.LOFTR.COARSE3.POST_CONFIG.RD = None
...
cfg.LOFTR.MATCH_CASCADE.THR = [0.0101, 0.0101]
cfg.LOFTR.MATCH_CASCADE.PRE_THR = [[0.2], [0.2, 0.2]]
cfg.LOFTR.MATCH_CASCADE.TEST_THR = [0.2, 0.2]
cfg.LOFTR.MATCH_CASCADE.BORDER_RM = [1, 2]
cfg.LOFTR.MATCH_CASCADE.DOUBLE_CHECK = [True, True]
cfg.LOFTR.MATCH_CASCADE.MATCH_TYPE = ['softmax', 'softmax']
cfg.LOFTR.MATCH_CASCADE.DSMAX_TEMPERATURE = [1.0, 1.0]
cfg.LOFTR.MATCH_CASCADE.TRAIN_PAD_NUM_GT_MIN = [4096, 8192]  # should consider to batch size
...
cfg.LOFTR.CASCADE_LEVELS = [4, 2]
cfg.LOFTR.IS_RGB = True
cfg.LOFTR.TRAIN_SIZE = 704
cfg.LOFTR.FINE_CONCAT_COARSE_FEAT = False  # no need for coarse feature for 1/2 in stage4

cfg.TRAINER.CANONICAL_LR = 8e-3
cfg.TRAINER.WARMUP_STEP = 1875  # 3 epochs
cfg.TRAINER.WARMUP_RATIO = 0.1
cfg.TRAINER.MSLR_MILESTONES = [8, 12, 15, 18, 21, 24]
